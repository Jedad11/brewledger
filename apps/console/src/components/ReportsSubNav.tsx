...
// inventory/ledger/pnl/dish/overview); only 3 have a real route today
// (WBS 6.1 capture, 6.4 review, GAP-1 ledger, and WBS 7.7 overview are not
// built) -- omitted rather than linked dead, per this fix's own brief.
// Extend this list as each of those lands; do not add a route here before
// its page exists.
//
// Labels are the exact state_matrix.md section headers (docs/design/
// state_matrix.md lines 284/299/304), not the pnl page's own longer H1
