...
const MANIFEST = [
  ...
  // WBS 6.7 -- the recipe editor's live "ต้นทุนต่อแก้ว" preview
  // (previewRecipeCostSatang, packages/costing/src/recipes/preview.ts),
  // null the instant any recipe line's ingredient has unknown cost, never a
  // partial sum, never 0 -- verified by redline_reviewer's WBS 6.7 audit.
  "app/console/(app)/menu/[id]/MenuItemEditorForm.tsx",
];
